...
<html lang="en">
  ...
  <body class="vertical  light  ">
    <div class="wrapper">
      <nav class="topnav navbar navbar-light bg-gray-100">
      ...
      <aside class="sidebar-left border-right bg-gray-100 shadow" id="leftSidebar" data-simplebar>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements2">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="{{ url('admin/product') }}"><span class="ml-1 item-text">All Products</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="{{ url('admin/product/create') }}"><span class="ml-1 item-text">Add Product</span>
                  </a>
                </li>
              </ul>
            </li>
